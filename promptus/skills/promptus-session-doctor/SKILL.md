---
name: promptus-session-doctor
description: Preflight a long-running Promptus project before a session agent resumes. Use before trusting NOW, cached retrieval, graph traversal, governed thinker custody, or a prior health receipt. Strictly read-only; stale or ambiguous state fails closed and is reported, never repaired automatically.
---

# Promptus session doctor — portable workflow adapter
