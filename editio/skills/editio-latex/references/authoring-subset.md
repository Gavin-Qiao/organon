# The editio authoring subset (v1)
...
the publish gate requires **no ungraded, no unsourced, no overclaims**.

## Not in v1 (use the ```latex escape hatch)

Markdown tables and figures (they arrive with editio-tables / editio-figures as units),
nested lists, footnotes, nested claim spans, brackets inside span text.
