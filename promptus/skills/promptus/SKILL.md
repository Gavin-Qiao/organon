...
| change the project's direction (edit the Telos) | — | the `telos` skill's boundary: rewrite in place; the date + why become a ledger DECISION, the frontier goes to `kb-now` — never into `TELOS.md` |
