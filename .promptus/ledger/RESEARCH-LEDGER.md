...
<!-- kb:now-through event-20260906T051919Z-authorize-release-delivery-and-reconcile-human-documentation -->
The operator authorized completing releases and updates, then added READMEs and other human docs. Implementation PR 57 passed cross-platform CI at bd16aaa; requested documentation corrections are being added before merge. Existing implementation and benchmark evidence are retained with successor custody for changed documentation bytes.

## Open frontier

Finish the documentation gate and push PR 57, wait for its latest required checks, then merge and verify main CI. Cut separate Promptus 0.10.0 and Editio 0.8.0 release PRs from green main, merge before tagging exact merged commits, and watch publication. Authorization now covers completing this workflow; the prior stop-before-merge handoff is superseded.

## Next actions

1. Land the documentation sweep and implementation, then complete the two release cuts.
...
3. Preview each of Psi, MoT, Probatio and Mensura separately. Apply only derived-state adoption where preflight permits it. Preserve research Markdown, manuscripts, custom policy and existing warning debt; no automatic scientific repair or new optional backend.
