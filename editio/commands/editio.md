---
description: Start or resume a paper end to end — check the promptus store, scaffold .editio/paper/ for a venue, report section status, and route the next step (structure → render → build → audit). Run with no argument to resume, or a venue id (arxiv, tpami, nmi, neurips) to start.
argument-hint: "[venue]"
---
