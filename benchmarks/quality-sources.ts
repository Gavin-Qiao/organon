...
export function assertQuality(root:string){
 ...
 if(!physical.startsWith(join(realpathSync(tmpdir()),"organon-quality-"))||readFileSync(join(root,"marker"),"utf8")!==QUALITY_MARKER)throw new Error("unmarked private quality workspace");
 return physical;
}
